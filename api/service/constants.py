...
def get_module_stl_directory(module_id: UUID) -> Path:
    return get_module_resource_path(module_id) / STL_FILES_DIRNAME
...
def build_stl_relative_path(module_id: UUID, filename: str) -> str:
    return f"{module_id}/{STL_FILES_DIRNAME}/{filename}"
