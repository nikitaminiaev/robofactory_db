...
class MaterialsAspect(Base):
    __tablename__ = "materials_aspects"

    id = Column(Integer, primary_key=True)
    boom_list = Column(JSON, nullable=True)
    ...
    def __str__(self):
        return f"PartCad(id={self.id!r}, creation_date={self.created_ts!r}, " + \
               f"update_date={self.updated_ts!r}, geometry_data={self.boom_list!r})"
